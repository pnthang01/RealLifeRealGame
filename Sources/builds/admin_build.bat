...
if not exist "%CURRENT_DIR%\WebServer\BackendWeb\admin\pom.xml" goto :error
cd "%CURRENT_DIR%\WebServer\BackendWeb\admin\"
call mvn clean package

goto :movefile

:movefile
MOVE  "%CURRENT_DIR%\WebServer\BackendWeb\admin\target\*.war" "%CURRENT_DIR%\builds\"
