...
public class StatisticWebServiceReader extends BaseWebServiceReader<StatisticDTO>{
	...
	private final String GET_LOGIN_STATISTIC_URL = "statistic/getLoginStatistic";
	
	public StatisticDTO getAllBadges() throws RestClientException, ConvertException{
		return this.getAnObject(GET_LOGIN_STATISTIC_URL, MODULE_NAME, null);
	}
