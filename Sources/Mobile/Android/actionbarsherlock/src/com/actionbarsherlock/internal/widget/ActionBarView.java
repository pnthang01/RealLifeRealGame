...
public class ActionBarView extends AbsActionBarView {
    ...
    /**
     * Set the action bar title type face. This will always replace or override window titles.
     * @param typeface Typeface to set
     */
    public void setTitleTypeface(Typeface typeface) {
    	mUserTitle = true;
        setTitleTypefaceImpl(typeface);
    }
    ...
    private void setTitleTypefaceImpl(Typeface typeface) {
        if (mTitleView != null) {
