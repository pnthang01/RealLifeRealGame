...
public class ViewPagerFragment extends NghiemFragment implements OnPageChangeListener
{
    public static final int TYPE_NORMAL = 0;
    public static final int TYPE_TITLE_STRIP = 1;
    public static final int TYPE_TAB_STRIP = 2;

    private static class ParallaxTransformer implements
            ViewPager.PageTransformer
    {
        ...
        public void transformPage(View root, float position)
        {
            ...
            float imageWidthInsideView = imageWidth
                    * (1 - IMAGE_SIZE_WIDTH_OUT_VIEW_PERCENT);
            float newImageWidth = viewWidth
                    / (1 - IMAGE_SIZE_WIDTH_OUT_VIEW_PERCENT);
            ...
            float dx = (position + 1) * newImageWidth
                    * IMAGE_SIZE_WIDTH_OUT_VIEW_PERCENT / -2;
    ...
    public void setParallax(ImageView background)
    {
        mViewPager.setPageTransformer(false,
                new ParallaxTransformer(background));
    }
