...
public class Mail extends Authenticator
{
    ...
    public Mail(String host, String port, String socket, String user,
            String pass)
    {
    ...
    public Mail(String host, String port, String socket, String user,
            String pass, String from, String subject, String body,
            boolean isAuthen)
    {
        mHost = host;
        mPort = port;
