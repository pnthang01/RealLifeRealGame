...
public class StringUtils
{
     ...
     * "<html><head><style type='text/css'>body {font-size: %dpx; text-align: left; margin: 0px 0px 0px 0px;}</style></head><body %s>%s</body></html>"
     * ; private static final String WEB_CONTENT_FONT_FACE_APPLIED =
     * "<html><head><style type='text/css'>@font-face {font-family: 'custom_font'; src: url('%s')} body {font-family: 'custom_font'; font-size: %dpx;text-align: left; margin: 0px 0px 0px 0px;}</style></head><body bgcolor='%s' text='%s'>%s</body></html>"
    ...
    public static final boolean isValidEmail(String email)
    {
        ...
        if (email.length() > email.trim().length())
        {
            throw new IllegalArgumentException(
                    "The string has unexpected character!");
        }
