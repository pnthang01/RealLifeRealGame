...
public class ActionBarActivity extends NghiemActivity implements
        OnScrollUpDownListener
{
    ...
    public void setBtnActionBarRightOne(Drawable icon,
    ...
    public void setBtnActionBarRightTwo(Drawable icon,
            View.OnClickListener callback)
    {
    ...
    public void setBtnActionBarRightOne(Bitmap icon,
            View.OnClickListener callback)
    {
    ...
    public void setBtnActionBarRightTwo(Bitmap icon,
            View.OnClickListener callback)
    {
            ...
            View.OnClickListener callback)
    {
        if (icon != null)
        {
            ...
            LOG.debug("set action bar button " + view.toString() + "with icon "
                    + icon.toString());
        }
    }
