...
public class MonthFragment extends ListViewFragment<Task>
{
	public static final String TAG = MonthFragment.class.getName();

	public static MonthFragment newInstance()
	{
		return new MonthFragment(R.layout.list_view, R.layout.list_item_game);
	}

	public MonthFragment(int listLayout, int itemLayout)
	{
