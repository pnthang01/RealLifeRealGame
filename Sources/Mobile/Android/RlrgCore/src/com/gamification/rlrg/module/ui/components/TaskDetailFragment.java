...
final class TaskDetailFragment extends NghiemFragment implements OnClickListener
{
    ...
    private TextView mTxtName, mTxtCategory, mTxtDifficulty, mTxtComplete,
            mTxtPoint, mTxtStatus;
    private Task mTask;
    ...
    public void onStart()
    {
        ...
        mActivity.setBtnActionBarRightText(
                mTask.getStatus().equals(mStatus[0]) ? R.string.action_mark_as_complete : R.string.action_mark_as_uncomplete,
                this);
    }
    ...
    public void onClick(View view)
    {
        ...
        DataPreferencesManager.getInstance().saveJsonTasks(
                new Gson().toJson(mTasks, Tasks.class));
