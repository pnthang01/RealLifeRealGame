...
public class TomorrowFragment extends ListViewFragment<Task>
{
	public static final String TAG = TomorrowFragment.class.getName();

	public static TomorrowFragment newInstance()
	{
		return new TomorrowFragment(R.layout.list_view, R.layout.list_item_game);
	}

	public TomorrowFragment(int listLayout, int itemLayout)
	{
